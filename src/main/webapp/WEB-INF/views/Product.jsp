...
<h1>add product details here</h1>
  ...
  <input type="text" name="productname" placeholder="enter product name"class="email" />
...
<select name="category">
  ...
  <input type="text" name="color" placeholder="color" class="email" />
   ...
   <input type="file" name="image" class="email" />

<div class="btn" style="width: 90%;"><input type="submit" name="submit" value="create product">
</div></a>
