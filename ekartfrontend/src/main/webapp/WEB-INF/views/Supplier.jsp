...
<div class="box">
<h1>add supplier datails here</h1>

  <input type="text" name="name" placeholder="enter supplier name" class="email" />

<input type="text" name="email" placeholder="email" class="email" />

  <input type="text" name="address" placeholder="address" class="email" />
  
   <input type="text" name="phone" placeholder="phone no" class="email" />
